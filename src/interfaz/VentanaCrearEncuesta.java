...
public class VentanaCrearEncuesta extends JFrame implements ActionListener {
	...
	public void crear() {
		try {
			if (preguntas != null) {
				encuesta = profesorActual.crearActividadEncuesta(titulo, objetivo, descripcion, nivel, duracionMinutos, obligatorio);    					
	...
	public void mostrarVentanaPrerequisitos() {
		...
		{
			ventanaPrerequisitos = new VentanaAgregarPrerequisitos(encuesta, profesorActual);
